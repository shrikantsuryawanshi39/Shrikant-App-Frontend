    ...
    <div className="block">
      <div className="w-[95dvw] bg-[rgba(196,196,196,0.36)] text-black flex flex-col items-center justify-center mx-auto my-10 rounded-2xl shadow-lg p-20">
        ...
        <div className="w-[90dvw] mb-8 bg-white max-h-full">
          <div
            className={`overflow-hidden border rounded shadow transition-all duration-300 ${userExpanded ? "max-h-[800px]" : "max-h-[250px]"
              }`}>
            <UserList />
          </div>
        </div>
        ...
        <div className="w-[90dvw] mb-8 bg-white">
          <div
            className={`overflow-hidden border rounded shadow transition-all duration-300 ${clusterExpanded ? "max-h-[800px]" : "max-h-[250px]"
              }`}>
            <ClusterList />
          </div>
        </div>
